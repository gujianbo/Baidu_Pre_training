...
def evaluate_all_metric(qid_list, label_list, score_list, freq_list=None):
    ...
    result_list = [dcg_all, dcg_high_freq, dcg_mid_freq, dcg_low_freq, ndcg_all, ndcg_high_freq, ndcg_mid_freq,
                   ndcg_low_freq, pnr, err_all, err_high_freq, err_mid_freq, err_low_freq]
    for item in result_list:
        results_dict.update(item)
    return results_dict